...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // Modal.js
      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            // Run this handler when the element slides into the viewport
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    // this.siteHeader & this.pageSections are JQUERY objects.
...
var rvlFeatureItems = new _RevealOnScroll2.default((0, _jquery2.default)(".feature-item"), "85%");
var rvlTestimonials = new _RevealOnScroll2.default((0, _jquery2.default)(".testimonial"), "60%");
